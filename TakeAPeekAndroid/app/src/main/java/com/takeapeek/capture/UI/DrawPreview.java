...
*/
		...
		if( camera_controller != null && !preview.isPreviewPaused() ) {
			...
			boolean draw_angle = false;//@@has_level_angle && sharedPreferences.getBoolean(PreferenceKeys.getShowAnglePreferenceKey(), true);
			boolean draw_geo_direction = false;//@@has_geo_direction && sharedPreferences.getBoolean(PreferenceKeys.getShowGeoDirectionPreferenceKey(), true);
			if( draw_angle ) {
