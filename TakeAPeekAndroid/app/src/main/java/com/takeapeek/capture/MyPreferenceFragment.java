...
public class MyPreferenceFragment extends PreferenceFragment implements OnSharedPreferenceChangeListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if( widths != null && heights != null ) {
			...
			String resolution_preference_key = com.takeapeek.capture.PreferenceKeys.getResolutionPreferenceKey(cameraId);
		...
		if( video_quality != null && video_quality_string != null ) {
			...
			lp.setEntries(entries);
			lp.setEntryValues(values);
			String video_quality_preference_key = com.takeapeek.capture.PreferenceKeys.getVideoQualityPreferenceKey(cameraId);
        ...
        }*/
        {
        	...
        	pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                    ...
                    CaptureClipActivity main_activity = (CaptureClipActivity)MyPreferenceFragment.this.getActivity();
            ...
            pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                	if( pref.getKey().equals("preference_using_saf") ) {
            			...
            			if( sharedPreferences.getBoolean(com.takeapeek.capture.PreferenceKeys.getUsingSAFPreferenceKey(), false) ) {
                    		if( MyDebug.LOG )
            ...
            pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                	if( pref.getKey().equals("preference_donate") ) {
            	        ...
            	        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(CaptureClipActivity.getDonateLink()));
        	        	startActivity(browserIntent);
                		return false;
                	}
                	return false;
            ...
            pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                	if( pref.getKey().equals("preference_about") ) {
                        ...
                        about_string.append("\nAuto-stabilise enabled?: " + sharedPreferences.getBoolean(com.takeapeek.capture.PreferenceKeys.getAutoStabilisePreferenceKey(), false));
                        about_string.append("\nFace detection?: ");
                		...
                		about_string.append("\nUsing SAF?: " + sharedPreferences.getBoolean(com.takeapeek.capture.PreferenceKeys.getUsingSAFPreferenceKey(), false));
                		String save_location = sharedPreferences.getString(com.takeapeek.capture.PreferenceKeys.getSaveLocationPreferenceKey(), "OpenCamera");
                		about_string.append("\nSave Location: " + save_location);
                		String save_location_saf = sharedPreferences.getString(com.takeapeek.capture.PreferenceKeys.getSaveLocationSAFPreferenceKey(), "");
                        ...
                        alertDialog.setNegativeButton("copy_to_clipboard", new DialogInterface.OnClickListener() {
