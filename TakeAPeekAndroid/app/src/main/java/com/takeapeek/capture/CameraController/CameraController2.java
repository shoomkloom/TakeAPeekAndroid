...
public class CameraController2 extends CameraController
{
     ...
     */
	public CameraController2(Context context, int cameraId, final ErrorCallback preview_error_cb, final ErrorCallback camera_error_cb) throws com.takeapeek.capture.CameraController.CameraControllerException
    {
		super(cameraId);
        //@@        //@@if( MyDebug.LOG ) 
